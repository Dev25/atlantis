...
- Click **Create** and record the access token
  ...
  NOTE: Atlantis will send the token as a [Bearer token to the Bitbucket API](https://confluence.atlassian.com/bitbucketserver/http-access-tokens-939515499.html#HTTPaccesstokens-UsingHTTPaccesstokens)
